...
def ali_pay():
    ...
    # 申请的沙箱环境的app_id
    alipay_config.app_id = "2016092500593093"
    # 商户的私钥
...
class AliPayView(APIView):
    ...
    def post(self, request):
        ...
        # page_execute是带页面的二维码链接，execute是不带页面的二维码
        response = client.page_execute(request, http_method="GET")
        # print(response)
        return redirect(response)


# 由于return_url和notify_url不支持本地服务器，下面这个视图就是
# http://140.143.63.45:8000/alipay_handler这个接口的视图函数
# 这里只用于测试，具体逻辑要自己设计
